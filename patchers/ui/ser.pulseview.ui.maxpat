...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 261.0, 20.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 7.0, 18.0, 22.0 ],
					"text" : "+",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 261.0, 22.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 74.0, 12.0, 12.0, 12.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 253.0, 30.0, 128.0, 128.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 61.0, 100.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 61.0, 141.0, 30.0, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 272.0, 277.0, 56.0, 22.0 ],
					"text" : "listfunnel"
				}
...
, 			{
				"box" : 				{
					...
					"blinkcolor" : [ 1.0, 0.882352941176471, 0.67843137254902, 1.0 ],
					"blinktime" : 20,
					"id" : "obj-18",
					"ignoreclick" : 1,
					"maxclass" : "button",
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 508.0, 374.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 66.0, 2.0, 16.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlinecolor" : [ 1.0, 0.709803921568627, 0.196078431372549, 0.0 ],
					"parameter_enable" : 0,
					"patching_rect" : [ 449.0, 374.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 50.0, 2.0, 16.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlinecolor" : [ 1.0, 0.709803921568627, 0.196078431372549, 0.0 ],
					"parameter_enable" : 0,
					"patching_rect" : [ 388.0, 374.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 2.0, 16.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlinecolor" : [ 1.0, 0.709803921568627, 0.196078431372549, 0.0 ],
					"parameter_enable" : 0,
					"patching_rect" : [ 331.0, 374.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 18.0, 2.0, 16.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlinecolor" : [ 1.0, 0.709803921568627, 0.196078431372549, 0.0 ],
					"parameter_enable" : 0,
					"patching_rect" : [ 272.0, 374.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 2.0, 16.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 508.0, 340.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 449.0, 340.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 390.0, 340.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 331.0, 340.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 272.0, 340.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 272.0, 248.0, 19.0, 22.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 272.0, 304.0, 255.0, 22.0 ],
					"text" : "spray 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 272.0, 215.0, 116.0, 22.0 ],
...
,
					"patching_rect" : [ 35.0, 215.0, 71.0, 22.0 ],
					"text" : "p panel_ctrl"
				}
...
,
					"patching_rect" : [ 112.0, 215.0, 75.0, 22.0 ],
					"text" : "p matrix_fmt"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 88.0, 263.0, 82.0, 18.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 387.0, 30.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 83.0, 20.0 ],
					"proportion" : 0.5,
					"rounded" : 0
